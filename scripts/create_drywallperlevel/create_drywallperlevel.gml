...
repeat(25 - global.level)
{
	...
	instance_create_layer(xbuild, ybuild, "Materials_Back", o_drywall);

	/// @DnDAction : YoYo Games.Instances.Create_Instance
	/// @DnDVersion : 1
	/// @DnDHash : 06A22694
	/// @DnDParent : 10335DD2
	/// @DnDArgument : "xpos" "1280 - xbuild"
	/// @DnDArgument : "ypos" "ybuild"
	/// @DnDArgument : "objectid" "o_drywall"
	/// @DnDArgument : "layer" ""Materials_Back""
	/// @DnDSaveInfo : "objectid" "4cb37350-5f56-41cc-b0bd-0fa7f1a51fc0"
	instance_create_layer(1280 - xbuild, ybuild, "Materials_Back", o_drywall);
}