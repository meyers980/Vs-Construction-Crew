...
///@DnDHash : 4824A8BE
///@DnDInput : 0
///@DnDArgument : "funcName" "check_state_door"
function check_state_door() {
	...
	if(state == ma.OPEN)
	{
		...
		/// @DnDArgument : "var_3" "shadow.image_index"
		/// @DnDArgument : "var_4" "shadow.state"
		/// @DnDArgument : "var_5" "shadow.image_speed"
		image_index = 0;
		state = ma.IDLE;
		image_speed = 1;
		shadow.image_index = 0;
		shadow.state = ma.IDLE;
		shadow.image_speed = 1;
